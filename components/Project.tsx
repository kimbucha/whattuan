...
function Project({title, 
  ...
  return (
    ...
    }} className="group mb-3 sm:mb-7 last:mb-28 ">
      <section 
          ...
          >
            ...
            <div className="pt-4 pb-7 px-5 sm:pl-10 sm:pr-2 sm:pt-10 sm:max-w-[50%] flex flex-col h-full sm:group-even:ml-[18rem] ">
              ...
              <p className='mt-2 leading-relaxed text-gray-700 dark:text-white/70 lowercase'>{description}</p>
            ...
            <Image src={imageUrl} alt="Projects" quality={95} className='absolute hidden sm:block top-8 -right-40 w-[28.25rem] rounded-t-lg shadow-2xl 
